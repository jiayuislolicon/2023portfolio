...
const personaInfos: Info[] = [
	...
	},
	{
		...
		color: "white",
		className:
			"col-start-3 col-end-7 lg:col-start-7 lg:col-end-10 mb-[45px] lg:mb-0 lg:mt-[100px]",
	},
	{
		title: "TECHNOLOGY",
		content: "asdf",
	...
	},
	{
		...
		color: "white",
		className:
			"col-start-3 col-end-7 lg:col-start-8 lg:col-end-11 mb-[120px] lg:mb-0 lg:mt-[270px]",
	},
];
