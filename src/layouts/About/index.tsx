	...
	return (
		<section className='grid-layout py-[105px] relative'>
			<BgCircle
				round
				color='white'
				className='absolute z-[-1] top-0 left-1/2 -translate-x-1/2'
			/>
			<h2 className='col-start-1 col-end-7 lg:col-end-13 text-center text-green-blue mb-[30px] leading-none'>
				ABOUT
			</h2>
