...
const Works = () => {
	...
	const fixSection = () => {
		...
		if (contentTop < 0 && contentBottom > window.innerHeight * 2) setInfoStatus("isFixed");

		if (contentBottom < window.innerHeight * 2) setInfoStatus("isBottom");
	};

	const hanldeResize = () => {
		setContainerHeight(container.current!.clientHeight - window.innerHeight * 2);
	};
